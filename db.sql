...
CREATE TABLE `comments` (
  ...
  KEY `S_ID_idx` (`S_ID`),
  CONSTRAINT `S_ID` FOREIGN KEY (`S_ID`) REFERENCES `students` (`S_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `dormitories` VALUES (6,'綜合宿舍'),(7,'第一宿舍'),(8,'第二宿舍');
...
INSERT INTO `managers` VALUES ('M1234567','黃舍監','test@mail.nuk.edu.tw','0909999123','test'),('M2345678','陳舍監','test2@mail.nuk.edu.tw','0912999004','test');
...
CREATE TABLE `permissions` (
  ...
  CONSTRAINT `M_ID` FOREIGN KEY (`M_ID`) REFERENCES `managers` (`M_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `permissions` VALUES (54,'M1234567',6),(55,'M2345678',7),(56,'M2345678',8);
...
INSERT INTO `registers` VALUES (26,'A1095512',8,119,2,'2023-01-09 12:30:35',123456),(27,'A1095548',6,119,2,'2023-01-09 12:31:15',0);
...
INSERT INTO `room_contents` VALUES (26,6,100,'牙刷',2),(27,6,100,'洗面乳',4),(28,6,102,'砧板',2),(29,6,102,'廚房',1),(30,7,100,'洗衣機',2),(32,7,666,'便當盒',2),(33,6,101,'鋤頭',3),(34,7,101,'巧克力蛋糕',3),(35,6,101,'桌子',4),(36,8,100,'遊戲片',2),(37,8,101,'薯條',3);
...
CREATE TABLE `rooms` (
  ...
  CONSTRAINT `D_ID_3` FOREIGN KEY (`D_ID`) REFERENCES `dormitories` (`D_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rooms` VALUES (6,100,4,2048),(6,101,4,4096),(6,102,3,2345),(7,100,3,3333),(7,101,3,1024),(7,102,8,9999),(7,666,2,5487),(8,100,10,123456),(8,101,3,123);
...
INSERT INTO `students` VALUES ('A1095512','林敬寶',109,'資訊工程系','a1095512@mail.nuk.edu.tw','0908850282',0,8,100,'a1095512'),('A1095525','張彣謙',109,'資訊工程系','a1095525@mail.nuk.edu.tw','0901234567',0,NULL,NULL,'a1095525'),('A1095547','陳于瑞',109,'資訊工程系','a1095547@mail.nuk.edu.tw','0923456789',0,NULL,NULL,'a1095547'),('A1095548','陳弘恩',109,'資訊工程系','a1095548@mail.nuk.edu.tw','0912345678',0,6,102,'a1095548'),('bill','比爾蓋茲',110,'電腦王系','bill@mail.nuk.edu.tw','0999999999',1,NULL,NULL,'bill');
...
INSERT INTO `violation_records` VALUES (6,'A1095512','吃完巧克力蛋糕沒丟回收','2023-01-09 12:20:27'),(7,'A1095548','笑太大聲','2023-01-09 12:23:46');
...
-- Dump completed on 2023-01-09 12:37:28
